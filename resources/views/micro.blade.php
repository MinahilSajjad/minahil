...
<div class="custom-tab-wrapper">
  <div class="elementor-tabs-wrapper" role="tablist">
    <div id="elementor-tab-title-2941" class="elementor-tab-title active" data-tab="1">Micro Enterprise Loan</div>
    <div id="elementor-tab-title-2942" class="elementor-tab-title" data-tab="2">Desi Murghbani Scheme</div>
  </div>

  <div class="elementor-tabs-content-wrapper">
    <div id="elementor-tab-content-2941" class="elementor-tab-content active" data-tab="1">
      <table class="responsive table">
        <tbody>
          <tr><td>Purpose</td><td>To encourage small scale enterprises, create self-employment opportunities, generate economic activities and reduce poverty</td></tr>
          <tr><td>Eligibility</td><td>AJK Nationals, especially low income groups and skilled persons</td></tr>
          <tr><td>Age Limit</td><td>18-60 Years</td></tr>
          <tr><td>Loan Limit</td><td>Maximum Rs. 100,000/-</td></tr>
          <tr><td>Tenure</td><td>Maximum 36 months</td></tr>
          <tr><td>Repayment</td><td>Monthly Installments</td></tr>
          <tr><td>Security</td><td>One PG of BPS-11 or above, Lien on Deposit or Gold</td></tr>
          <tr><td>Insurance</td><td>As per Bank’s Policy</td></tr>
          <tr><td>Margin on Stock</td><td>10% to 25%</td></tr>
        </tbody>
      </table>
    </div>

    <div id="elementor-tab-content-2942" class="elementor-tab-content" data-tab="2">
      <table class="responsive table">
        <tbody>
          <tr><td>Purpose</td><td>Promotion of Desi Murghbani/Poultry by establishing small units of minimum 10 poultry birds at cottage level (for economic empowerment of rural women). The units will comprise of grown-up Desi layer stock purchased from local suppliers. Promoting organic chicken and eggs, generating income, reducing poverty.</td></tr>
          <tr><td>Eligibility</td><td>AJK Nationals, Only Women</td></tr>
          <tr><td>Age Limit</td><td>18-60 Years</td></tr>
          <tr><td>Loan Limit</td><td>Rs. 15,000/- to Rs. 50,000/- per unit</td></tr>
          <tr><td>Tenure</td><td>Maximum 18 months</td></tr>
          <tr><td>Repayment</td><td>Half yearly equal installments</td></tr>
          <tr><td>Security</td><td>One PG of BPS-11 or above, Lien on Deposit or Gold</td></tr>
          <tr><td>Insurance</td><td>As per Bank’s Policy</td></tr>
        </tbody>
      </table>
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    tabButtons.forEach(button => {
      button.addEventListener("click", () => {
        ...
        document.querySelector(`#elementor-tab-content-294${tabId}`).classList.add("active");
      });
    });
  });
</script>
