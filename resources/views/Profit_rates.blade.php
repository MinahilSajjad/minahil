...
<style>
  ...
  table.profit-rates th, table.profit-rates td {
    border: 1px solid #ddd;
    padding: 12px 15px;
    font-size: 16px;
  }
  table.profit-rates thead {
    background-color: #224407;
    color: white;
    text-align: left;
  }
  table.profit-rates tbody tr:nth-child(even) {
    background-color: #f5f9ff;
  }
  table.profit-rates tbody tr:hover {
    background-color: #e3f2fd;
  }
  table.profit-rates td:last-child {
    text-align: right;
    font-weight: 600;
    color: #224407;
  }
...
<div class="profit-rates-container">
  <div class="profit-rates-title">
    Provisional Profit Rates For The Period November 05, 2024 to December 31, 2024
  </div>
  <table class="profit-rates">
    <thead>
      <tr>
        <th>Category of Deposit</th>
        <th>Provisional Profit Rate</th>
      </tr>
    </thead>
    <tbody>
      <tr><td>PLS Saving Deposit</td><td>12.00%</td></tr>
      <tr><td>BMBA</td><td>12.00%</td></tr>
      <tr><td>SDA (from 0.05M to Rs. 50M)</td><td>12.00%</td></tr>
      <tr><td>SDA (Above Rs. 50M to Rs. 100M)</td><td>12.00%</td></tr>
      <tr><td>SDA (Above Rs. 100M)</td><td>12.00%</td></tr>
      <tr><td>7 Days’ Notice Deposit</td><td>12.00%</td></tr>
      <tr><td>30 Days’ Deposit</td><td>7.00%</td></tr>
      <tr><td>3 Month TDR</td><td>11.00%</td></tr>
      <tr><td>6 Month TDR</td><td>10.50%</td></tr>
      <tr><td>1 Year TDR</td><td>10.00%</td></tr>
      <tr><td>2 Year TDR</td><td>8.50%</td></tr>
      <tr><td>3 Year TDR</td><td>8.65%</td></tr>
      <tr><td>4 Year TDR</td><td>8.80%</td></tr>
      <tr><td>5 Year TDR</td><td>8.90%</td></tr>
    </tbody>
  </table>
</div>
