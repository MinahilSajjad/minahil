  ...
  <div class="breadcrumb">
    ...
    <span>News & Update</span>
        ...
        <div class="tp-postbox-pagination">
          <ul>
            <li><a class="prev page-numbers" href="{{ route('news') }}"><i class="fa-regular fa-arrow-left"></i></a></li>
           
            <li><span class="page-numbers "href="{{ route('news') }}">1</span></li>
            <li><a class="page-numbers" href="{{ route('two') }}">2</a></li>
            
            <li><a class="next page-numbers" href="{{ route('two') }}"><i class="fa-regular fa-arrow-right"></i></a></li>
          </ul>
        </div>
      </div>
      ...
      <div class="tp-sidebar-wrapper">
        <!-- Search -->
        <div class="tp-sidebar-widget widget_search">
          <h3 class="tp-sidebar-widget-title">Search</h3>
        ...
        <div class="tp-sidebar-widget">
          ...
          <div class="tp-rc__post">
            <div class="tp-rc__post-thumb">
              <a href="#"><img src="https://demo.bankajk.com/wp-content/uploads/2025/05/advance-salARY-loan-150x150.jpg" width="70" alt=""></a>
            </div>
            <div class="tp-rc__post-content">
              <h3 class="tp-rc__post-title"><a href="#">Advance Salary Loan Offer for Employees –</a></h3>
              <div class="tp-rc__post-meta"><span><i class="fa-regular fa-calendar-days"></i> May 16, 2025</span></div>
            </div>
          </div>
        ...
        <div class="tp-sidebar-widget">
          ...
          <ul>
            <li><a href="https://demo.bankajk.com/category/bod/">BOD</a></li>
            <li><a href="https://demo.bankajk.com/category/news-updates/">News & Updates</a></li>
          </ul>
        </div>
      </div>
