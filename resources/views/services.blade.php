...
<style>
  ...
  .tab-container {
    margin-top: 50px; /* This adds space below the header */
    padding: 0 20px;
  }
...
<div class="tab-container">
  <div class="tab-buttons">
    <button onclick="showTab(1)" id="tab-btn-1" class="active">Current Account</button>
    <button onclick="showTab(2)" id="tab-btn-2">PLS Savings Account</button>
    <button onclick="showTab(3)" id="tab-btn-3">Special Deposit Account</button>
    <button onclick="showTab(4)" id="tab-btn-4">BMBA</button>
    <button onclick="showTab(5)" id="tab-btn-5">PPRSA</button>
  </div>

  <div id="tab-1" class="tab-content active">
    <h1>Current Account</h1>
    <p><strong>Eligibility:</strong><br> Individuals, Business People, Companies, Govt. Departments, Trusts, NGOs, etc.</p>
    <ul>
      <li>Chequing account</li>
      <li>Single or joint account</li>
      <li>Min deposit: Rs. 1,000/-</li>
      <li>No withdrawal limit</li>
      <li>No Zakat deduction</li>
      <li>Free services if avg. balance ≥ Rs. 25,000/-</li>
      <li>Free locker if avg. balance ≥ Rs. 50,000/-</li>
    </ul>
  </div>

  <div id="tab-2" class="tab-content">
    <h1>PLS Savings Account</h1>
    <p><strong>Eligibility:</strong><br> Individuals (single/joint), Gov. entities for provident/benevolent funds.</p>
    <ul>
      <li>Profit-earning chequing account</li>
      <li>Min deposit: Rs. 500/-</li>
      <li>Free services if avg. balance ≥ Rs. 100,000/-</li>
      <li>Profit paid half yearly</li>
      <li>No withdrawal limit</li>
      <li>Zakat applicable</li>
    </ul>
  </div>

  <div id="tab-3" class="tab-content">
    <h1>Special Deposit Account</h1>
    <p><strong>Eligibility:</strong><br> Similar to Current Account holders.</p>
    <ul>
      <li>Suitable for business</li>
      <li>Profit paid half yearly (daily product basis)</li>
      <li>No withdrawal restrictions</li>
      <li>Profit eligibility: daily balance ≥ Rs. 50,000/-</li>
      <li>Free services if avg. balance ≥ Rs. 100,000/-</li>
    </ul>
  </div>
  ...
  <div id="tab-4" class="tab-content">
    <h1>BMBA</h1>
    <p><strong>Eligibility:</strong><br> Individuals, business entities, govt. bodies, NGOs, etc.</p>
    <ul>
      <li>Open with Rs. 1,000/-; profit from Rs. 25,000/-</li>
      <li>Max 2 withdrawals allowed (6th–end of month)</li>
      <li>Monthly profit payment</li>
      <li>Free locker if avg. balance ≥ Rs. 50,000/-</li>
      <li>Up to 95% financing on low markup</li>
    </ul>
  </div>
  ...
  <div id="tab-5" class="tab-content">
    ...
    <ul>
      <li>Individuals receiving remittances via MoneyGram, Western Union, Ria, etc.</li>
      <li>Only remittance deposits allowed</li>
      <li>Documentary proof of remittance required</li>
    </ul>
    <p><strong>Features:</strong></p>
    <ul>
      <li>Extra 1% profit over standard rate</li>
      <li>Monthly profit payment</li>
      <li>Free cheque book</li>
      <li>Min balance: Rs. 1,000/-</li>
      <li>Zakat and tax as per law</li>
    </ul>
  </div>
</div>
