...
<div class="service-container">
  ...
  <div class="service-card">
    <svg class="service-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      <path d="M12 2C9.79 2 8 3.79 8 6v2H6v14h12V8h-2V6c0-2.21-1.79-4-4-4zm-2 6V6c0-1.1.9-2 2-2s2 .9 2 2v2H10zm6 12H8v-8h8v8z"/>
    </svg>
    <h3 class="service-title">Lockers Facility</h3>
    <p class="service-text">
      Lockers available in Muzaffarabad, Mirpur, and Rawalakot. Sizes: Small, Medium, Large. Annual fee + Security Deposit. Account required.
    </p>
    <img src="https://demo.bankajk.com/wp-content/uploads/2023/10/locker.jpg" alt="Locker" class="service-img">
  </div>
  ...
  <div class="service-card">
    ...
    <h3 class="service-title">Utility Bills Collection</h3>
    <p class="service-text">
      Pay electricity bills at any branch. Easy, reliable, and convenient bill payment service across our entire branch network.
    </p>
    <img src="https://demo.bankajk.com/wp-content/uploads/2023/10/utility-bill.png" alt="Utility Bills" class="service-img">
  </div>
  ...
  <div class="service-card">
    ...
    <h3 class="service-title">Services for AJK PSC</h3>
    <p class="service-text">
      We collect AJK PSC application fees and provide forms at all branches. Hassle-free, supportive services for all applicants.
    </p>
    <img src="https://demo.bankajk.com/wp-content/uploads/2023/10/psc.jpg" alt="PSC Services" class="service-img">
  </div>
